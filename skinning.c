...
#endif
    win = glfwCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, "Demo2", NULL, NULL);
...
//        media.skin = image_load("../skins/old_tron_skin.png");
    ...
    while (!glfwWindowShouldClose(win))
    {
        ...
        if (nk_begin(&ctx, "Demo1", nk_rect(50, 50, 300, 400),
